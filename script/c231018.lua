...
--search monster
function s.filter(c)
	return c:IsSetCard(0x231) and c:IsMonster() and c:IsAbleToHand()
end
...
function s.filter2(c)
	return (c:IsSetCard(0x231) or c:IsSetCard(0x232)) and (c:IsMonster() or c:IsSpellTrap())	and c:IsAbleToHand()
end
